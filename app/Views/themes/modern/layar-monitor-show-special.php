	...
	<div class="block-container">
		...
		<div class="content-container">
			...
			<div class="content-middle-bottom-container">
				...
				{
					$simpan = true;
					if (isset($antrian_detail_fix[$val['id_antrian_tujuan']])){
						if($antrian_detail_fix[$val['id_antrian_tujuan']]['id_antrian_panggilan'] > $val['id_antrian_panggilan']){
							$simpan = false;
						}
					}
					if($simpan){
						$antrian_detail_fix[$val['id_antrian_tujuan']] = $val;
					}
				}
				foreach ($antrian_detail_fix as $val) 
				{
					...
					if ($val['id_antrian_detail']) {
						echo '<div class="box-antrian" data-id-kategori="' . $val['id_antrian_kategori'] . '" data-id-tujuan="' . $val['id_antrian_tujuan'] . '">
