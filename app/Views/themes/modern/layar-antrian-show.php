...
<script type="text/javascript" src="<?=$config->baseURL . 'public/themes/modern/js/antrian-ambil-liveupdate.js?r='.time()?>"></script>
			...
			<div class="ambil-antrian-container">
				...
				<div class="button-container">
					...
					foreach ($antrian_kategori as $val) {
						echo '<button style="background:' . $list_background[$index] . '" class="btn ambil-antrian" data-id-antrian-kategori="' . $val['id_antrian_kategori'] . '"><span>' . $val['nama_antrian_kategori'] . '</span><span style="font-size: 40px;" id="no_antrian_' . $val['id_antrian_kategori'] . '">---</span></button>';
						$index++;
