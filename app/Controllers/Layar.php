...
class Layar extends \App\Controllers\BaseController
{
	...
	public function show_layar_monitor() 
	{
		...
		if (!empty($_GET['id'])) 
		{
			...
			if (!empty($_GET['spc'])) 
			{
				$this->addJs( $this->config->baseURL . 'public/themes/modern/js/layar-liveupdate-monitor-antrian-special.js' );
				echo view('themes/modern/layar-monitor-show-special.php', $this->data);
				die;
			}
