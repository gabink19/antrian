		...
		$.ajax({
			...
			success : function(data) 
			{
				...
				if (kategori) {
					...
					if (kategori.aktif == 'Y') {
						...
						$elm.each(function(i, elm) 
						{
							...
							id_antrian_tujuan = $(elm).attr('data-id-tujuan');
							nomor_antrian = 0;
							if (id_antrian_tujuan in kategori.tujuan_panggil) {
								nomor_antrian = kategori.tujuan_panggil[id_antrian_tujuan].nomor_panggil;
							}
				...
				if (tujuan) {
					...
					{
						$elm = $('div[data-id-tujuan="' + tujuan.id_antrian_tujuan + '"');
